...
app.get('/api/jokes', (req, res) => {
    ...
    const filteredJokes = jokeType ? jokes.filter(j => j.jokeType === jokeType) : jokes;
...
// 8. DELETE all jokes
app.delete('/api/jokes', (req, res) => {
    jokes = [];
    res.send('All jokes deleted');
});

app.listen(port, () => {
    console.log(`Jokes API listening at http://localhost:${port}`);
});
